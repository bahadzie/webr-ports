...
PKG_NAME="svglite"
PKG_URL="https://cran.r-project.org/src/contrib/svglite_2.1.0.tar.gz"
...
cat << EOF > ~/.R/Makevars 
CXX11=em++
CXX11FLAGS=-std=gnu++11 -I../../../cpp11/inst/include -I/app/build/R-4.1.2/include
LDFLAGS=-s SIDE_MODULE=1 -s WASM_BIGINT -s ASSERTIONS=1 -s USE_LIBPNG=1
EOF
