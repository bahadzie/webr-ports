...
CXX=em++
CXX11=em++
CXX11FLAGS=-std=gnu++11 -Oz -D__STRICT_ANSI__ -I/app/build/R-4.1.2/include
CFLAGS=-std=gnu11 -Oz -I/app/build/R-4.1.2/include
LDFLAGS=-Oz -s SIDE_MODULE=1 -s WASM_BIGINT -s ASSERTIONS=1
AR=emar
EOF
...
cat stringi_data.js >> "../../dist/${PKG_NAME}/${PKG_NAME}.js"
rm -rf root
rm ~/.R/Makevars
